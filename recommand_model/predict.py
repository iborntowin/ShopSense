...
try:
    ...
    print(f"   → {len(df)} customers in database")
    print(f"   → {len(item_list)} items available")
    print(f"   → {kmeans_model.n_clusters} customer segments")
...
if __name__ == "__main__":
    ...
    print("\n📊 Test 1: Get recommendations for Customer 100")
    result = get_recommendations(customer_id=100, top_n=5)
    ...
    print("\n📊 Test 4: Popular items in Segment 0")
